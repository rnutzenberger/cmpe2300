...
namespace RNutzenbergerICA8
{
    class Ball
    {
        ...
        private PointF _ballLoc;
        private float _xVel;
        private float _yVel;
        private int _ballRad;
        public Color BallColor { get; set; }

        public Ball(PointF ballLoc, Color ballColor)
        {
            _xVel = (float)_rnd.NextDouble() * 10  - 5; // -5  to 5 range? 10, 0-10 set offset ? -5
            _yVel = (float)_rnd.NextDouble()* 10 - 5;
